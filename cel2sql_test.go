...
func TestConvert(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want:    "REGEXP_CONTAINS(\"\\x00\" || \"foo\" || \"\\x00\", \"((bar))\") AND REGEXP_CONTAINS(\"\\x00\" || \"foo\" || \"\\x00\", \"((bar))\") AND REGEXP_CONTAINS(\"\\x00\" || ARRAY_TO_STRING([\"foo\"], \"\\x00\") || \"\\x00\", \"((bar))\") AND REGEXP_CONTAINS(\"\\x00\" || ARRAY_TO_STRING([\"foo\"], \"\\x00\") || \"\\x00\", \"((bar))\")",
			wantErr: false,
		},
		{
			...
			want:    "REGEXP_CONTAINS(\"\\x00\" || \"foo\" || \"\\x00\", \"(?i)((bar))\") AND REGEXP_CONTAINS(\"\\x00\" || \"foo\" || \"\\x00\", \"(?i)((bar))\") AND REGEXP_CONTAINS(\"\\x00\" || ARRAY_TO_STRING([\"foo\"], \"\\x00\") || \"\\x00\", \"(?i)((bar))\") AND REGEXP_CONTAINS(\"\\x00\" || ARRAY_TO_STRING([\"foo\"], \"\\x00\") || \"\\x00\", \"(?i)((bar))\")",
			wantErr: false,
		},
	}
